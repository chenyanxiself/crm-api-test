...
res = requests.get(url='https://socialapidev2.bjx.cloud/social-api/sys/user/queryLoginUserPermissions?_t=1594025976',
                   headers={'admin-token': 'bb6fc764d23a4dd5818820ddd59694d8'}).text
...
def init_permission():
    ...
    requests.post(url='https://socialapidev2.bjx.cloud/social-api/sys/permission/saveRolePermissions',headers={
